...
describe('MainFeature Component', () => {
  ...
  test('renders the component correctly', () => {
    ...
    expect(screen.getByText(/7 nights at an estimated Rp820,198 a night/i)).toBeInTheDocument();
  ...
  test('opens and closes the modal when button is clicked', () => {
    ...
    expect(screen.queryByText(/Tell us about your place/i)).not.toBeInTheDocument();
  });
});
