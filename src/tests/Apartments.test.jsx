...
describe("Apartments Component", () => {
  ...
  test("renders the main heading", () => {
    const heading = screen.getByText(
      /need a place where you can host\? try airbnb-friendly apartments/i
    );
  ...
  test("renders the additional information", () => {
    const additionalInfo = screen.getByText(
      /weve partnered with apartment buildings across the us so you can rent a place to live and host on airbnb part-time/i
    );
