    ...
    <div className="max-w-screen-xl mx-auto py-12 text-center">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 px-4">
        <div className="text-center mt-12">
          <h2 className="text-2xl md:text-3xl font-semibold text-red-500 mb-0 lg:leading-[1.3] lg:text-[2.8rem]">
            Airbnb it.
          </h2>
          <p className="text-xl md:text-2xl font-semibold text-gray-900 mb-2 lg:text-[2.8rem] mb-6">
            You could earn
          </p>
          <p className="text-[48px] md:text-[68px] font-bold text-gray-900 mt-2">
            Rp {formattedEarnings}
          </p>
          <p className="text-lg md:text-xl">7 nights at an estimated Rp820,198 a night</p>
          <div className="my-6">
            <input
              type="range"
              min="1000000"
