  ...
  return (
    <div className="max-w-screen-lg mx-auto py-12 text-center px-4">
      <h1 className="text-2xl md:text-3xl font-bold mb-8 lg:text-[2.8rem] lg:leading-[1.2]">
        Need a place where you can host? <br />
      ...
      <p className="text-sm text-gray-800 mb-8 px-4">
        *The typical Host earnings amount represents the median amount of
        earnings for Hosts in US Airbnb-friendly apartment buildings between Jan
        1 - Dec 31, 2023, according to internal Airbnb data for revenue earned
        by Hosts.
      </p>
