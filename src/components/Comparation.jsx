...
const Comparation = () => {
  return (
    <div className="max-w-full lg:max-w-[47%] mx-auto py-6 my-[3rem] px-4">
      ...
      />
      <h2 className="text-xl lg:text-[2.8rem] font-bold mb-10 text-center leading-[1]">
      ...
      <table className="min-w-full table-auto">
        <thead>
          <tr className="text-left">
            ...
            <th className="px-4 lg:px-6 py-3 text-lg lg:text-[1.3rem] font-semibold text-gray-600 text-center">
              Airbnb
            </th>
            <th className="px-4 lg:px-6 py-3 text-lg lg:text-[1.3rem] font-semibold text-gray-600 text-center">
              Competitors
          ...
          {data.map((item, index) => (
            <tr key={index} className="border-t border-gray-300">
              <td className="py-2 lg:py-4 text-gray-700">
                <h2 className="text-sm lg:text-lg font-semibold text-gray-600">
                  {item.title}
                </h2>
              ...
              <td className="py-2 lg:py-4 text-center text-lg">
                <FontAwesomeIcon
                  ...
                  className={`${
                    item.airbnbStatus === faCheck
                      ? "text-green-500"
                      : "text-red-500"
                  } text-lg lg:text-[1.6rem]`}
                />
              </td>
              <td className="py-2 lg:py-4 text-center text-lg">
                <FontAwesomeIcon
                  ...
                  className={`${
                    item.competitorsStatus === faCheck
                      ? "text-green-500"
                      : "text-red-500"
                  } text-lg lg:text-[1.6rem]`}
                />
