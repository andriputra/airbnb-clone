...
const accordionData = [
  ...
  },
  {
    ...
    answer:
      "Its up to you. Some Hosts prefer to message guests only at key moments—like sending a short note when they check in—while others also enjoy meeting their guests in person. Youll find a style that works for you and your guests.",
  },
  {
    question: "Any tips on being a great Airbnb Host?",
    answer:
      "Getting the basics down goes a long way. Keep your place clean, respond to guests promptly, and provide necessary amenities, like fresh towels. Some Hosts like adding a personal touch, such as putting out fresh flowers or sharing a list of local places to explore—but its not required.",
  },
  {
    question: "What are Airbnbs fees?",
    answer:
  ...
  return (
    <section className="bg-[#f7f7f7] py-[5rem]">
              ...
              >
                ...
                <FontAwesomeIcon
                  ...
                  className={`transition-transform duration-300 ${
                    openIndex === index ? "rotate-120" : ""
                  }`}
                />
              </button>
              {openIndex === index && (
                <div className="py-4 text-gray-600 text-sm md:text-base">
                  {item.answer}
                </div>
              )}
            </div>
      ...
      <div className="max-w-screen-xl mx-auto bg-white rounded-[15px] flex flex-col md:flex-row items-center my-8">
        <div
          className="w-full md:w-1/2 h-48 md:h-80 bg-cover bg-center rounded-xl"
